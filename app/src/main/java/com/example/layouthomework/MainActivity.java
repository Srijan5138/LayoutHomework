...
public class MainActivity extends AppCompatActivity {
    ...
    public void countUp(View view) {
        ...
        buttonzero.setBackgroundColor(getResources().getColor(R.color.purple_200));
        switch (mCount%2){
            case 0: buttoncount.setBackgroundColor(getResources().getColor(R.color.teal_700));
                break;
    ...
    public void showZero(View view) {
        ...
        buttoncount.setBackgroundColor(getResources().getColor(R.color.teal_700));
    }
}